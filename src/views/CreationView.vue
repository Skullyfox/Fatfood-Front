...
<template>
    <div class="container">
        <div class="creationContainer" :style="saveMode ? 'grid-template-columns: 2fr 1fr' : 'grid-template-columns: 2fr 1.8fr 2fr;'">
            <div class="leftContainer">
                <div class="card"
                    :style="creationMode ? `transform: translateX(0%);` : `transform: translateX(-400%);`">
                    <div class="header_card">
                        <h1>Indice Calorifique</h1>
                        <p 
                            :class="`${kcalColor()}`">{{ totalKcal() }} kcal</p>
                    </div>
                            ...
                            <div class="price_column">
                                ...
                                <ul>
                                    <li 
                                        v-for="ingredient in recipe" 
                                        :key="ingredient.attributes.nom">
                                        <p>{{ (ingredient.attributes.prix * quantity).toFixed(2).toString().replace('.','€') }}</p>
                                    </li>
            ...
            <div class="previewContainer">
                <ul 
                    :style="creationMode ? `` : `padding-top: 50px`">
                    <li 
                        v-for="ingredient, index in recipe" 
                        :key="ingredient.nom"
                        :class="`ingredientType-${ingredient.attributes.ingredient_type.data.id}`"
                        :style="creationMode && !saveMode
                        ...
                        >
                        <img 
                            :src="ingredient.attributes.picture.data.attributes.url"
                ...
                <div class="card"
                    ...
                    <div class="body_card">
                        <div class="addSection">
                            ...
                            <button 
                                @click="addIngredientToRecipe(selectedIngredient)"
                                :disabled="recipe.length >= 9">
                                <i class="fas fa-plus" />
                            </button>
                        </div>
                        ...
                        <ul>
                            <li 
                                ...
                                <div class="controls">
                                    <button
                                        :style="index === 0 || index === recipe.length - 1 ? 'display: none' : ''"
